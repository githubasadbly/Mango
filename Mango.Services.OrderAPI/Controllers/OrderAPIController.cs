    ...
    public class OrderAPIController : ControllerBase
    {
        ...
        public async Task<ResponseDto> ValidateStripeSession([FromBody] int orderHeaderId)
        {
            try
            {
                ...
                var paymentIntentSerice = new PaymentIntentService();
                PaymentIntent paymentIntent = paymentIntentSerice.Get(session.PaymentIntentId);

                if (paymentIntent.Status == "succeeded")
                {
                    //then payment was successfull
                    orderHeader.PaymentIndentedId = paymentIntent.Id;
                ...
                if (orderHeader != null)
                {
                    if (newStatus == SD.Status_Cancelled)
                    {
                        ...
                        var options = new RefundCreateOptions
                        {
                            ...
                            PaymentIntent = orderHeader.PaymentIndentedId
                        };
